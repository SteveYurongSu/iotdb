...
public interface PointCollector {
   ...
   * <p>
   * Before calling this method, you need to ensure that the UDTF output data type is set to {@code
   * TSDataType.INT32} by calling {@link UDFConfigurations#setOutputDataType(TSDataType)} in {@link
   * UDTF#beforeStart(UDFParameters, UDFConfigurations)}.
   *
   ...
   * {@link UDTF#beforeStart(UDFParameters, UDFConfigurations)}.
   *
   * @param timestamp timestamp to collect
