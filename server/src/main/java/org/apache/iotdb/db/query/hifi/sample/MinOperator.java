...
public class MinOperator<T extends Number & Comparable<? super T>> extends SampleOperator<T> {

  public MinOperator(TSDataType type) {
    super(type);
  }
  ...
  protected void sampleFromSingleBucket(List<Long> originalTimestamps, List<T> originalValues,
    ...
    for (int i = loIndex; i < hiIndex; ++i) {
      ...
      if (value.compareTo(valueCandidate) < 0) {
